...
router.get('/stats/summary', async (req, res) => {
  try {
    ...
    const ALL_ACTIONS = [
      ...
      { type: 'dashboard', action: '화제성분석_정보검색' },
      { type: 'dashboard', action: '화제성분석_보고서생성' },
      { type: 'dashboard', action: '화제성분석_PDF다운로드' },
      { type: 'dashboard', action: '화제성분석_MD다운로드' },
      ...
      { type: 'admin', action: '카카오봇_설정조회' },
      { type: 'admin', action: '카카오봇_설정저장' },
      { type: 'admin', action: '카카오봇_방추가' },
      { type: 'admin', action: '카카오봇_방삭제' },
      { type: 'admin', action: '카카오봇_방토글_enabled' },
      { type: 'admin', action: '카카오봇_방토글_scheduleNotify' },
      { type: 'admin', action: '카카오봇_방토글_commandsEnabled' },
      { type: 'admin', action: '카카오봇_outbox조회' },
